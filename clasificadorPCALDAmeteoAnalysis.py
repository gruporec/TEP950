...
for ltpitems in range(minltpitems,maxltpitems,stepltp):
    ...
    for meteoitems in range(minmeteoitems,maxmeteoitems,stepmeteo):
        ...
        ltpv=ltpv_orig.resample(str(fltp)+'S').mean()
        ltpt=ltpt_orig.resample(str(fltp)+'S').mean()
        meteoP_norm=meteoP_norm_orig.resample(str(fmeteo)+'S').mean()
        meteoT_norm=meteoT_norm_orig.resample(str(fmeteo)+'S').mean()
