...
res.to_csv('resClasLDA'+str(nDias)+'Dias'+year_train+year_data+'.csv')
...
nDias=str(nDias)
#si no existen, crea las carpetas 1_1 a 3_3 en figurasClasificadorLDA+nDias+Dias
if not os.path.exists('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data):
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data)
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/1_1')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/1_2')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/1_3')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/2_1')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/2_2')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/2_3')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/3_1')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/3_2')
    os.makedirs('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/3_3')
...
for i in range(len(res_estado)):
    ...
    for j in range(len(res_estado.columns)):
        ...
        f.savefig('figurasClasificadorLDA'+nDias+'Dias'+year_train+year_data+'/'+str(int(res_estado.iloc[i,j]))+'_'+str(int(res_valdata.iloc[i,j]))+'/'+res_estado.columns[j]+'_'+res_estado.index[i].strftime('%Y-%m-%d')+'.png')
        # cierra la figura f
        plt.close(f)
