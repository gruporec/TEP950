...
listest=['LTP diff_1h','LTP diff_R_Neta_Avg_norm','LTP Area_n0','LTP diff_R_Neta_Avg','LTP Min_n0','LTP Max_n0']
ventanas=[1,10,2,10,1,1]
f_olvido=[0.8,0.95,0.8,0.8,0.8,0.8]
# f_olvido=[0,0,0,0,0,0]
listest=['LTP diff_1h']
ventanas=[1]
f_olvido=[0]
