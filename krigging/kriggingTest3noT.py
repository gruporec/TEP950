...
class KriggingClassifier:
    ...
    # Constructor
    def __init__(self, Xtrain, alpha):
        self.Xtrain = Xtrain
        self.alpha = alpha
    ...
    def update_matrices(self, Xtrain, alpha):
        ...
        #self.P = np.zeros([Xtrain.shape[1], Xtrain.shape[1]])
        self.P = np.eye(Xtrain.shape[1])*2
        ...
        self.q = np.zeros([Xtrain.shape[1]])
        ...
        self.A = np.zeros([Xtrain.shape[0]+1, Xtrain.shape[1]])
...
kr_lambda = KriggingClassifier(X_train.T, alph)
...
for i in range(X_train.shape[0]):
    ...
    y_pred_lambda = kr_lambda.apply(X_train[i])[1]
