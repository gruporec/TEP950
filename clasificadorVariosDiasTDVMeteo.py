...
tdv_meteo_train = pca.transform(tdv_meteo_train)
tdv_meteo_test = pca.transform(tdv_meteo_test)
...
lda.fit(tdv_meteo_train,data_train)

#aplica el clasificador a los datos de tdv_meteo
data_train_pred = lda.predict(tdv_meteo_train)
data_test_pred = lda.predict(tdv_meteo_test)
