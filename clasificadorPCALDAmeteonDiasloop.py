...
ltpPBase = ltpP.copy()
ltpTBase = ltpT.copy()
valdatapdBase=valdatapd.copy()
trdatapdBase=trdatapd.copy()
# crea un array de tamaño MaxnDias
acc=np.zeros(MaxnDias)
for nDias in range(MaxnDias):
# crea ltp_1 copiando ltp
    ltpP_1 = ltpPBase.copy()
    ltpT_1 = ltpTBase.copy()
    ltpP = ltpPBase.copy()
    ltpT = ltpTBase.copy()
    valdatapd = valdatapdBase.copy()
    trdatapd = trdatapdBase.copy()
