...
acierto = np.zeros(fltpMax)
for fltp10 in range(1,fltpMax,1):
    fltp=fltp10/10
    ...
    acierto[fltp10-1]=accuracy

# grafica el porcentaje de acierto
plt.plot((np.arange(1,len(acierto)+1))/10,acierto)
plt.xlabel('Periodo de muestreo')
