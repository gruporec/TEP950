...
#si no existen, crea las carpetas 1_1 a 3_3 en figurasClasificadorCurvQDA
if not os.path.exists('figurasClasificadorCurvQDA'+year_train+year_data):
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data)
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/1_1')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/1_2')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/1_3')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/2_1')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/2_2')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/2_3')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/3_1')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/3_2')
    os.makedirs('figurasClasificadorCurvQDA'+year_train+year_data+'/3_3')
...
f.savefig('figurasClasificadorCurvQDA'+year_train+year_data+'/'+year_train+'blobs.png')
# cierra la figura f
plt.close(f)
...
# guarda la figura f en la carpeta figurasClasificadorConvolucion con el nombre de la columna de res_estado, indice de res_estado y valor de res_estado y valdatapd
f.savefig('figurasClasificadorCurvQDA'+year_train+year_data+'/'+year_data+'blobs.png')
# cierra la figura f
plt.close(f)

# guarda res en un archivo csv
res.to_csv('resClasCurvQDA'+year_train+year_data+'.csv')
...
for i in range(len(res_estado)):
    ...
    for j in range(len(res_estado.columns)):
        ...
        # guarda la figura f en la carpeta figurasClasificadorConvolucion con el nombre de la columna de res_estado, indice de res_estado y valor de res_estado y valdatapd
        f.savefig('figurasClasificadorCurvQDA'+year_train+year_data+'/'+str(int(res_estado.iloc[i,j]))+'_'+str(int(res_valdata.iloc[i,j]))+'/'+res_estado.columns[j]+'_'+res_estado.index[i].strftime('%Y-%m-%d')+'.png')
        # cierra la figura f
        plt.close(f)
