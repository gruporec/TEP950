...
if __name__=='__main__':
    ...
    meta_file='ignore/resultadosTDV/batch/PCALDA/meta2.csv'
    ...
    tests = pd.read_csv('ignore/resultadosTDV/batch/PCALDA/programmedTests3.csv')
    ...
    for index, row in tests.iterrows():
        if row['done']==False:
            ...
            res_file_target='ignore/resultadosTDV/batch/PCALDA/'+str(index)
            ...
            tests.to_csv('ignore/resultadosTDV/batch/PCALDA/programmedTests3.csv',index=True)
