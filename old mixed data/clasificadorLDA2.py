...
# # remuestrea trdatapd a minutal con el valor de cada día
# trdatapdT = trdatapd.resample('T').pad()
# # obtiene el índice interseccion de valdatapd y ltp
# valdatapd_ltp = valdatapdT.index.intersection(ltpP.index)
# trdatapd_ltp = trdatapdT.index.intersection(ltpT.index)
# # recorta valdatapd según el índice interseccion
# valdatapdT = valdatapdT.loc[valdatapd_ltp,:]
# trdatapdT = trdatapdT.loc[trdatapd_ltp,:]
# #obtiene de nuevo valdatapd a partir de valdatapdT
# valdatapd = valdatapdT.resample('D').first()
# #obtiene de nuevo trdatapd a partir de trdatapdT
# trdatapd = trdatapdT.resample('D').first()
