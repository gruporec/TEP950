...
res_file='ignore/resultadosTDV/PCA_LDA_results_temp_ref.csv'
...
temp_step_scale = 5
batch_size = 5 # 20 es demasiado para 400 epochs (2% en más de 12 horas). 200 de temperatura puede estar bien; revisar. No parece que los resultados mejoren mucho.
epochs = 100
