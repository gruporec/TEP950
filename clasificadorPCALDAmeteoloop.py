...
acc=np.zeros(MaxComp)

for comp in range(MaxComp):
    #aplica PCA
...
plt.plot(range(1,MaxComp+1),acc)
...
res.to_csv('resClasPCALDAMeteo'+year_train+year_data+'.csv')
...
#si no existen, crea las carpetas 1_1 a 3_3 en figurasClasificadorPCALDAMeteo
if not os.path.exists('figurasClasificadorPCALDAMeteo'+year_train+year_data):
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data)
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/1_1')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/1_2')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/1_3')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/2_1')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/2_2')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/2_3')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/3_1')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/3_2')
    os.makedirs('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/3_3')
...
for i in range(len(res_estado)):
    ...
    for j in range(len(res_estado.columns)):
        ...
        f.savefig('figurasClasificadorPCALDAMeteo'+year_train+year_data+'/'+str(int(res_estado.iloc[i,j]))+'_'+str(int(res_valdata.iloc[i,j]))+'/'+res_estado.columns[j]+'_'+res_estado.index[i].strftime('%Y-%m-%d')+'.png')
        # cierra la figura f
        plt.close(f)
