...
#si no existen, crea las carpetas 1_1 a 3_3 en figurasClasificadorNB
if not os.path.exists('figurasClasificadorNB'):
    os.makedirs('figurasClasificadorNB')
    os.makedirs('figurasClasificadorNB/1_1')
    os.makedirs('figurasClasificadorNB/1_2')
    os.makedirs('figurasClasificadorNB/1_3')
    os.makedirs('figurasClasificadorNB/2_1')
    os.makedirs('figurasClasificadorNB/2_2')
    os.makedirs('figurasClasificadorNB/2_3')
    os.makedirs('figurasClasificadorNB/3_1')
    os.makedirs('figurasClasificadorNB/3_2')
    os.makedirs('figurasClasificadorNB/3_3')
...
for i in range(len(res_estado)):
    ...
    for j in range(len(res_estado.columns)):
        ...
        f.savefig('figurasClasificadorNB/'+str(int(res_estado.iloc[i,j]))+'_'+str(int(res_valdata.iloc[i,j]))+'/'+res_estado.columns[j]+'_'+res_estado.index[i].strftime('%Y-%m-%d')+'.png')
        # cierra la figura f
        plt.close(f)
