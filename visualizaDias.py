...
# grafica ltp_1 poniendo la hora normalizada en el eje x
axlpt1.plot(ltp_1,ls='none',marker='o',color='black',alpha=alphaValue*60*24/len(ltp_1),MarkerSize=1)
axlpt1.set_xlim(0,24)
axlpt1.set_ylim(-2.5,2.5)
axlpt1.set_title('LTP_1')
# grafica ltp_2 poniendo la hora normalizada en el eje x
axlpt2.plot(ltp_2,ls='none',marker='o',color='black',alpha=alphaValue*60*24/len(ltp_2),MarkerSize=1)
axlpt2.set_xlim(0,24)
axlpt2.set_ylim(-2.5,2.5)
axlpt2.set_title('LTP_2')
# grafica ltp_3 poniendo la hora normalizada en el eje x
axlpt3.plot(ltp_3,ls='none',marker='o',color='black',alpha=alphaValue*60*24/len(ltp_3),MarkerSize=1)
axlpt3.set_xlim(0,24)
axlpt3.set_ylim(-2.5,2.5)
...
fig.savefig('figuras dias/diarios'+year+'.png')
fig2.savefig('figuras dias/medias'+year+'.png')
