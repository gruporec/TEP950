...
# Carga de datos
dfT = pd.read_csv("rawMinutales"+year+".csv",na_values='.')
...
dfd = pd.read_csv("rawDiarios"+year+".csv",na_values='.')
...
#combina los dataframes de las medias de los 3 ltp en uno solo renombrando las columnas
ltp_media=pd.concat([ltp_1_media,ltp_2_media,ltp_3_media],axis=1)
ltp_media.columns=['LTP_1','LTP_2','LTP_3']
...
# añade los dataframes al de las medias
ltp_media=pd.concat([ltp_media,ltp_1_std,ltp_2_std,ltp_3_std],axis=1)
ltp_media.columns=['LTP_1','LTP_2','LTP_3','LTP_1_std','LTP_2_std','LTP_3_std']
...
# añade los dataframes al de las medias
ltp_media=pd.concat([ltp_media,diff_1_media,diff_2_media,diff_3_media],axis=1)
ltp_media.columns=['LTP_1','LTP_2','LTP_3','LTP_1_std','LTP_2_std','LTP_3_std','DIFF_1','DIFF_2','DIFF_3']
...
# añade los dataframes al de las medias
ltp_media=pd.concat([ltp_media,diff_1_std,diff_2_std,diff_3_std],axis=1)
ltp_media.columns=['LTP_1','LTP_2','LTP_3','LTP_1_std','LTP_2_std','LTP_3_std','DIFF_1','DIFF_2','DIFF_3','DIFF_1_std','DIFF_2_std','DIFF_3_std']
#guarda los dataframes en un archivo csv
ltp_media.to_csv('ltp_media'+year+'.csv')
